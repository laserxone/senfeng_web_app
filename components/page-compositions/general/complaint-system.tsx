...
const taskCategories: Array<{
  ...
  {
    label: "Machine Upgradation",
    value: "Machine Upgradation",
    icon: ArrowUpCircle,
  },
...
function SummaryBox({ label, value }: { label: string; value: number }) {
  ...
  return (
    <div className="flex items-center gap-3 border-t px-4 py-3 first:border-t-0 sm:border-t-0 sm:px-5">
      <Icon
        className={`size-4 ${label === "Paid" ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400"}`}
      />
...
function InfoItem({
  ...
  return (
    <div className={className}>
      ...
      <div className="mt-0.5 text-xs leading-5 font-semibold break-words text-foreground">
        {value || "N/A"}
      </div>
    </div>
  )
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 flex-1">
              <div className="flex min-w-0 flex-wrap items-center gap-2">
                <p className="max-w-full min-w-0 truncate text-sm leading-5 font-bold">
              ...
              <div className="mt-1 flex min-w-0 flex-wrap items-center gap-x-2 gap-y-1 text-xs text-muted-foreground">
                ...
                <span className="truncate">
                  {complaint.customer_owner || "No owner"}
                </span>
                <span className="hidden text-border sm:inline">|</span>
                ...
                {complaint.logs.map((item, index) => (
                  ...
                  >
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0 flex-1">
                        <p className="text-xs leading-5 font-semibold break-words">
                      ...
                      <div className="flex shrink-0 flex-wrap items-center gap-2 sm:justify-end">
                        ...
                        {item.signature && (
                          <MyImgZooming img={item.signature} />
                        )}
          ...
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Register customer complaint and service information.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <DialogHeader className="border-b border-border bg-muted/40 px-4 py-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Select the engineer responsible for this complaint.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <DialogHeader className="border-b border-border bg-muted/40 px-4 py-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Record the resolution details before closing.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <DialogHeader className="border-b border-border bg-muted/40 px-4 py-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Record complaint payment and supporting information.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <DialogHeader className="border-b border-border bg-muted/40 px-4 py-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Update complaint and customer service details.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
