...
export default function SectionTitle({ title, subtitle, icon, option, children }: { title: string; subtitle: string; icon: ReactNode, option: number, children?: ReactNode }) {
    const colorClasses = [
    ...
    return (
        <div className="flex items-center gap-3 justify-between">
            <div className="flex gap-3 items-center">
                <div className={`flex size-9 shrink-0 items-center justify-center rounded-xl border ${colorClasses[option]}`}>{icon}</div>
