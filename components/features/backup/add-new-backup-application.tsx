                        ...
                        >
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    {customerID &&
                                        ...
                                        <Field data-invalid={Boolean(formErrors.saleId)}>
                                            <FieldLabel>Machine <RequiredStar /></FieldLabel>
                                    ...
                                    {formData.saleId &&
                                        ...
                                        <Field data-invalid={Boolean(formErrors.inventoryId)}>
                                            <FieldLabel>Backup Item <RequiredStar /></FieldLabel>

                                            <BackupInventory value={formData.inventoryId ?? null} onReturn={(e) => updateField(
                                                "inventoryId",
                                                e
                                            )} />
                                            <FieldError
                            ...
                            <FieldSet className="space-y-4 rounded-lg border p-4">
                                ...
                                <Field>
                                    ...
                                    <Dropzone value={formData.image} onDropFile={(f) => handleImageUpload(f as File)} />
