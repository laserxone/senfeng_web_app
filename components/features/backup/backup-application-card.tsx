        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <CardDescription className="mt-1">
              {application.shipment_name || "No shipment specified"}
            </CardDescription>
          </div>
          ...
          <div className="flex shrink-0 flex-col items-end gap-1">
            ...
            {application.my_approval_status &&
              application.my_approval_status !== "pending" && (
                <Badge
                  className={cn(
                    "text-xs",
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p>{formatDate(application.date_of_delivery)}</p>
          </div>

          <div>
            <p className="text-xs text-muted-foreground">Expected Return</p>

            <p>{formatDate(application.expected_return_date)}</p>
          </div>
        </div>
