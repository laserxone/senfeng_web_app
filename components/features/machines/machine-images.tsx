              ...
              <div className="rounded-2xl border bg-background p-4 shadow-sm">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-xl border bg-muted/20 p-3">
                    ...
                    <Label className="block text-sm font-semibold break-words text-foreground">
                      {note || "Not provided"}
                    </Label>
                  </div>
                  ...
                  <div className="rounded-xl border bg-muted/20 p-3 sm:col-span-2">
                    ...
                    <Label className="block text-sm leading-6 font-medium break-words whitespace-pre-wrap text-foreground">
...
export const ViewImagesSheet = ({
  ...
  const renderImageGroup = (group: SheetImageGroup) => {
    ...
    return (
      <Card
        key={group.title}
        className="overflow-hidden border-0 bg-white p-0 shadow-sm ring-1 ring-slate-200/80 dark:bg-zinc-950 dark:ring-white/10"
      >
  ...
  ({ img, type, onDelete, imageType, imageIndex = -1 }: RenderImageProps) => {
    ...
    return (
      <div className="group relative overflow-hidden rounded-lg border bg-slate-50 shadow-sm transition-shadow hover:shadow-md dark:bg-zinc-900/70">
        ...
        {type && (
          <Badge className="absolute top-2 left-2 h-5 rounded-full bg-slate-900/80 px-2 text-[10px] text-white">
            PDF
          </Badge>
        )}
        {onDelete && (
          ...
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Upload categorized machine documents, reports, and delivery
                photos.
              </DialogDescription>
            </div>
          </div>
        ...
        <ScrollArea className="max-h-[calc(100dvh-132px)]">
          ...
          >
                    ...
                    >
                      {[
                        ...
                        <Label
                          key={i}
                          htmlFor={item.value}
                          className={`flex min-h-14 cursor-pointer items-center gap-3 rounded-xl border p-3 text-sm transition hover:border-primary/40 hover:bg-muted/30 ${
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-3">
              <div className="mb-3 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Add multiple PNG or JPG files. You can also paste images
                    directly.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-3">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <Label className="text-sm font-semibold">Select PDF</Label>
                    <p className="mt-0.5 text-xs text-muted-foreground">
            ...
            <div className="flex flex-1 flex-wrap gap-2">
              ...
              <Button className="flex flex-1" type="submit" disabled={loading}>
