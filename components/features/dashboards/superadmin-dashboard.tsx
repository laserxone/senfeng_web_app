    ...
    <div className="flex flex-1 flex-col space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        ...
        <Card className="shadow-sm">
          <CardContent className="items-center gap-3">
            <div className="flex justify-between">
              <p className="truncate text-lg font-bold">Complaint Stats</p>
        ...
        <Card className="shadow-sm">
          <CardContent className="items-center gap-3">
            <div className="flex justify-between">
              <p className="truncate text-lg font-bold">POS Stats</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  {data?.total_machines_sold_this_month_data?.length ?? 0}{" "}
          ...
          <div className="space-y-2">
            {tasks.map((task) => {
              ...
              return (
                <div
                  key={task.id}
                  className={`group rounded-lg border p-3 text-sm shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${
                    completed
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`mt-0.5 grid h-8 w-8 shrink-0 place-items-center rounded-full border bg-background ${
                        completed
