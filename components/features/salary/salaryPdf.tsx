              ...
              <View style={styles.summaryContainer}>
                <View style={[styles.summaryBox, styles.totalAmount]}>
                  ...
                  <Text style={styles.summaryValue}>
                    Rs. {formatCurrency(Number(data?.payable || 0))}
                  </Text>
                </View>
          ...
          {commissionDetail && commissionDetail?.length > 0 && (
            <View style={styles.tableCommission}>
              <View style={[styles.commissionRow, styles.commissionHeaderRow]}>
                <Text style={[styles.commissionHeaderCell, { flex: 2 }]}>
                  Customer
                </Text>
                <Text style={[styles.commissionHeaderCell, { flex: 3 }]}>
                  Machine
                </Text>
                <Text style={[styles.commissionHeaderCell, { flex: 2 }]}>
                  Order No
  ...
  return (
    ...
    >
      <Text style={{ textAlign: "center" }}>
        DISCLAIMER: This is an auto generated salary slip and does not require a
        signature.
      </Text>
    </View>
  );
