      ...
      >
        ...
        >
              ...
              <View style={styles.summaryContainer}>
                <View style={[styles.summaryBox, styles.totalAmount]}>
                  ...
                  <Text style={styles.summaryValue}>
                    Rs. {formatCurrency(data?.total || 0)}
                  </Text>
                </View>
                ...
                <View style={[styles.summaryBox, styles.received]}>
                  ...
                  <Text style={styles.summaryValue}>
                    Rs. {formatCurrency(data?.received || 0)}
                  </Text>
                </View>
                ...
                <View style={[styles.summaryBox, styles.balance]}>
                  ...
                  <Text style={styles.summaryValue}>
                    Rs.{" "}
                    {formatCurrency((data?.total || 0) - (data?.received || 0))}
                  </Text>
                </View>
              </View>
            </View>
          ...
          <View style={{ width: "100%" }}>
            ...
            >
              {["DATE", "TID", "BANK", "MODE", "PAYMENT", "BALANCE"].map(
                (header, index) => (
                  <View
                    key={index}
                    style={[
            ...
            {data?.payments &&
              ...
              [...Array(20 - data?.payments.length)].map((_, i) => (
                <View
                  key={i}
                  style={{
                    width: "100%",
...
const FormField = ({ data }: { data: LocalData }) => {
  return (
    <View style={{ marginBottom: 5, flex: 0.5 }}>
      {["Company", "Name", "Contact", "Model", "Order No", "Manager"].map(
        (label, index) => (
          <View
            key={label}
            style={{
  ...
  return (
    ...
    >
      <View style={{ marginRight: 10, gap: 0, fontSize: "10px" }}>
        ...
        <Text style={{ color: "#7F7F7FFF", fontWeight: "600", fontSize: 10 }}>
...
const Header = ({ logoSrc }: { logoSrc: SourceObject }) => {
  return (
    ...
    >
      ...
      <Image
        src={logoSrc}
        style={{ height: 40, width: 200, objectFit: "contain" }}
      />
      <View
        style={{
          backgroundColor: "#0072BC",
  ...
  return (
    ...
    >
      <Text style={{ textAlign: "center" }}>
        DISCLAIMER: This is an auto generated Statement and does not require a
        signature.
      </Text>
    </View>
  );
