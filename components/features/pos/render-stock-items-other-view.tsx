...
const RenderStockItemsOtherView = ({
  ...
  return (
    <div
      className={`flex w-full flex-col rounded-md border bg-card p-2.5 ring-1 ring-border/30 transition hover:border-primary/40 ${
      ...
      {!editable ? (
        <div className="grid gap-2 md:grid-cols-[minmax(180px,1fr)_120px_120px_auto] md:items-center">
          <div className="min-w-0">
            <p className="text-sm leading-tight font-bold">{item.name}</p>
            {item.chinese_name && (
        ...
        <div className="grid gap-2">
          ...
          <div className="grid min-w-0 gap-2 sm:grid-cols-2">
            ...
            <Button
              size="sm"
              className="h-8 rounded-md text-xs sm:col-span-2"
      ...
      {edit && (
        <div className="mt-2 flex w-full items-center justify-between border-t pt-2">
          <div className="flex items-center gap-1 rounded-md border bg-background p-1">
            ...
            <p className="min-w-7 text-center text-xs font-bold">
              {invoiceItems?.find((eachItem) => eachItem.id === item.id)?.qty ??
                0}
            </p>
            <div
