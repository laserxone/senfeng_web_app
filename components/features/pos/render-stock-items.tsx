...
const RenderStockItems = ({
  ...
  return (
    <div
      className={`flex min-h-[180px] flex-col rounded-md border bg-card p-2.5 ring-1 ring-border/30 transition hover:border-primary/40 ${
      ...
      {!editable ? (
        <div className="flex flex-1 flex-col gap-2">
          ...
          <div className="min-w-0">
            <p className="line-clamp-2 min-h-9 text-sm leading-tight font-bold">
              {item.name}
            </p>
            {item.chinese_name && (
