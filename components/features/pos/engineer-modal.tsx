          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                {allEngineersData.length} active issue
                {allEngineersData.length === 1 ? "" : "s"}
              </p>
            </div>
      ...
      <div className="overflow-x-auto p-2">
        <table className="w-full min-w-[520px] table-auto text-xs">
          <thead className="bg-muted text-muted-foreground">
            <tr>
              <th className="rounded-l-md px-3 py-2 text-left font-bold">
                Name
              </th>
              <th className="px-3 py-2 text-right font-bold">Qty</th>
              <th className="px-3 py-2 text-right font-bold">Price</th>
              <th className="rounded-r-md px-3 py-2 text-right font-bold">
                Total
              </th>
            </tr>
          </thead>
