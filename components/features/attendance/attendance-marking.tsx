              ...
              <div className="mt-3 space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    {loading ? (
                      <Skeleton className="flex h-8 flex-1" />
                    ) : (
                      <Input
                        value={latitude}
                        readOnly
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-5 text-red-600">
                        Make sure location services are enabled and location
                        access is allowed in your browser, then refresh the page
                        and try again.
                      </p>
                    </div>
                  </div>
            ...
            {!longitude ? null : notAllowed ? (
              ...
              <>
                    ...
                    {reason === "Visit" && (
                      <div className="space-y-2">
                        ...
                        <CustomerSearch
                          ...
                          onReturn={(val) => setSelectedCustomer(val)}
                        />
                        {errors.customer && (
                          <p className="text-xs text-destructive">
                            {errors.customer}
                ...
                <FieldSet className="rounded-lg border p-4">
                  ...
                  <div className="mt-3 flex justify-center space-y-3">
                    <Dropzone
                      value={imagePreview}
