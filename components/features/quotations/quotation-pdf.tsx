      ...
      <Page size="A4" style={styles.page}>
          ...
          <View style={styles.bannerRight}>
            <View style={styles.bannerField}>
              ...
              <View>
                ...
                <Text style={styles.bannerFieldValue}>
                  {data.id || "0000-0000"}
                </Text>
              </View>
            </View>
        ...
        <View style={styles.machineSection}>
          <View style={styles.machineRow}>
            <Image
              src={publicFile("/machines/1.png?height=55&width=90")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/2.png?height=55&width=90")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/3.png?height=55&width=90")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/4.png?height=55&width=90")}
              style={styles.machineImage}
            />
          </View>
          <View style={styles.machineRow}>
            <Image
              src={publicFile("/machines/5.png?height=50&width=80")}
              style={styles.machineImageSmall}
            />
            ...
            <Image
              src={publicFile("/machines/6.png?height=50&width=80")}
              style={styles.machineImageSmall}
            />
          </View>
          <View style={styles.machineRow}>
            <Image
              src={publicFile("/machines/7.png?height=50&width=80")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/8.png?height=50&width=80")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/9.png?height=50&width=80")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/10.png?height=50&width=80")}
              style={styles.machineImage}
            />
            <Image
              src={publicFile("/machines/11.png?height=50&width=80")}
              style={styles.machineImage}
            />
          </View>
        </View>
            ...
            <View style={styles.footerLeft}>
              ...
              <View style={styles.footerCompanyInfo}>
                ...
                <View style={styles.footerInfoRow}>
                  <Image
                    src={publicFile("/png/map-pin.png")}
