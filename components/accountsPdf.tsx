          ...
          <View style={{ width: "100%", marginTop: 10 }}>
            ...
            {data?.map((item, index) => (
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 9, color: "black" }}>
                    {formatCurrency(Number(item?.payable) || 0)}
                  </Text>
                </View>
              </View>
            ))}
          ...
          <View style={styles.summaryContainer}>
            <View style={[styles.summaryBox, styles.totalAmount]}>
              ...
              <Text style={styles.summaryValue}>
                Rs. {formatCurrency(Number(total || 0))}
              </Text>
            </View>
          </View>
          <Disclaimer />
      ...
      {["Salary Month", "Paid On"].map((label, index) => (
        ...
        >
          ...
          >
            <Text>
              {index === 0
                ? moment(data?.salary_month).subtract(1, "month").format("MMMM YYYY")
  ...
  return (
    ...
    >
      <Text style={{ textAlign: "center" }}>
        DISCLAIMER: This is an auto generated slip and does not require a
        signature.
      </Text>
    </View>
  );
