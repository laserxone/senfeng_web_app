...
import AddVisit from "../users/add-visit";
import { QuotationForm } from "../users/quotation/quotation-form";
import AddReimbursementDialog from "../users/reimbursement/add-reimbursement";
...
export default function SalesQuickActions({ onRefreshCustomer, onRefreshFeedback, onRefreshQuotation, onRefreshReimbursement, onRefreshTask, onRefreshVisit }: Props) {
            ...
            <Card className="h-full w-full overflow-hidden border border-slate-200/80  shadow-sm ring-1 ring-black/5 xl:h-[300px] p-0">
                <CardContent className="flex h-full flex-col gap-3 p-4">
                    <div className="border-b border-slate-200/80 pb-3">
                        ...
                        <p className="text-xs text-muted-foreground">Create daily sales activity faster</p>
                    </div>
