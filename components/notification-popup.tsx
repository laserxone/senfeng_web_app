...
function PopupCard({ notification, baseRoute, onDismiss }: PopupCardProps) {
    ...
    return (
        ...
        >
            <div className="pointer-events-none absolute -right-16 -top-20 size-44 rounded-full bg-violet-500/15 blur-3xl dark:bg-violet-500/20" />
            ...
            <div className="relative flex items-start gap-3.5">
                <div className="relative mt-0.5 grid size-11 shrink-0 place-items-center rounded-2xl bg-gradient-to-br from-indigo-500 via-violet-600 to-fuchsia-600 text-white shadow-[0_10px_25px_-8px_rgba(124,58,237,0.8)] ring-1 ring-white/40">
                    ...
                    <span className="absolute -right-1 -top-1 grid size-4 place-items-center rounded-full border-2 border-white bg-emerald-400 shadow-sm dark:border-slate-950">
                ...
                <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-3">
                        <div>
                            <p className="flex items-center gap-1.5 text-[9px] font-extrabold uppercase tracking-[0.2em] text-violet-600 dark:text-violet-300">
                                <Sparkles className="size-3" />
                                {notification.category || "New notification"}
                            </p>
                            <h3 className="mt-1 line-clamp-1 text-sm font-bold leading-5 tracking-[-0.01em]">
                        ...
                        <button
                            ...
                            className="-mr-1 -mt-1 grid size-8 shrink-0 place-items-center rounded-full border border-transparent text-slate-400 transition-all hover:border-slate-200 hover:bg-white hover:text-slate-800 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 dark:hover:border-white/10 dark:hover:bg-white/10 dark:hover:text-white"
                        >
                    ...
                    {notification.page && (
                        <button
                            ...
                            disabled={isOpening}
                            className="group mt-3 inline-flex h-8 items-center gap-2 rounded-full border border-white/25 bg-gradient-to-r from-violet-600 to-indigo-600 px-3.5 text-[11px] font-bold text-white shadow-[0_8px_22px_-9px_rgba(109,40,217,0.8)] transition-all hover:-translate-y-0.5 hover:from-violet-500 hover:to-indigo-500 hover:shadow-[0_10px_26px_-9px_rgba(109,40,217,0.95)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 active:translate-y-0 dark:from-violet-500 dark:to-indigo-500 dark:hover:from-violet-400 dark:hover:to-indigo-400 disabled:cursor-wait disabled:opacity-60"
                        >
...
export default function NotificationPopup() {
    ...
    return (
        <aside
            ...
            className="pointer-events-none fixed right-3 top-3 z-[100] flex w-[calc(100vw-1.5rem)] max-w-[380px] flex-col gap-3 sm:right-6 sm:top-6"
        >
