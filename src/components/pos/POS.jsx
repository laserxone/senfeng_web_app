        ...
        (loading || customerLoading) ?
            ...
            <PageContainer scrollable={true}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                    ...
                    <ViewableInvoice address={address} companyName={companyName} invoiceItems={invoiceItems} manager={manager} name={name} nextInvoice={nextInvoice} phoneNumber={phoneNumber} selectedUser={selectedUser} totalAmount={totalAmount} warranty={warranty} warrantyYear={warrantyYear} />
                ...
                <POSModal checked={checked} modal={modal} setChecked={setChecked} setModal={setModal} onClick={() => {
                    setModal(false);
                    setLoading(true)
                    setCustomerLoading(true)
                    generatePDF()
                ...
                <AddPOSPayment visible={!!selectedInvoice} onClose={() => setSelectedInvoice(null)} part_id={selectedInvoice} customer_id={selectedCustomer?.id} onRefresh={async () => {
                    setLoading(true)
                    setCustomerLoading(true)
                    await fetchData()
                    await fetchDataCustomer()
                ...
                <EngineerModal allEngineersData={allEngineersData} engineersModal={engineersModal} setEngineersModal={setEngineersModal} onRefresh={async () => {
