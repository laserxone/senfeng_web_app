...
export default function Quotation() {
  ...
  const handleInvoiceBackendData = async () => {
    ...
    axios
      .put(`/api/pos/update/${selectedSearchItem.id}`, {
  ...
  const fetchData = async () => {
    ...
    //           response.data?.lastInventoryId + 1
    //         }`
    //       );
    //     }
    //   })
  ...
  const handleSelectCustomer = (customer) => {
    setPhoneNumber(customer.number.split(",")[0]);
    setName(customer.owner);
  ...
  return loading || customerLoading ? (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
      <div className="flex flex-1 p-2 flex-col p-6 border rounded-lg shadow-lg bg-gray-50 gap-4">
        <Label className="font-semibold">Existing customer?</Label>
        <div className="flex flex-row gap-5">
          <CustomerSearchWithData
            value={selectedCustomer}
            onReturn={(val) => {
              setSelectedCustomer(val);
              setPhoneNumber(val.number.join(", "));
              setName(val.owner);
        ...
        <div className="flex flex-row flex-wrap justify-between">
          ...
          <div>
            ...
            <Select onValueChange={setLasersource} value={lasersource}>
              <SelectTrigger className="w-[200px]">
                <SelectValue placeholder="Select laser source..." />
              </SelectTrigger>
              <SelectContent>
                {["RAYCUS", "MAX"]
                  .map((item) => ({ value: item, label: item }))
        ...
        <div className="flex justify-end w-full mt-4">
          <div className="flex border rounded-md overflow-hidden">
            <div className="w-[200px] bg-gray-200 p-3 font-bold text-center">
              Total Amount
            </div>
            <Input
              className={cn(
                "flex h-[47px] w-[300px] px-3 py-1 text-base bg-transparent shadow-none border-none focus:outline-none focus:ring-0 focus-visible:ring-0"
              )}
              type="number"
              value={total}
            ...
            {/* <div className="flex-1 bg-white p-3 font-bold text-center">
        ...
        {searchInvocie && (
          <div className="flex w-full gap-4">
            <Input
              placeholder="Search by: invoice no, phone no, customer name, company name"
              value={itemSearch}
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                ...
                <tbody>
                  {invoiceItems.map((item, i) => (
                    ...
                    >
                      <td
                        style={{ border: "1px solid #D1D5DB", paddingLeft: 5 }}
                      >
                        <Label>{i + 1}</Label>
                      </td>
                      <td
                    ...
                    [...Array(10 - invoiceItems.length)].map((_, i) => (
                      <tr key={i} style={{ fontSize: 14, height: 30 }}>
                        <td
                          ...
                          style={{ paddingLeft: 5 }}
                        >
                          <Label>{i + invoiceItems.length + 1}</Label>
                        </td>
                        <td
                          className="border border-gray-300 "
                          style={{ paddingLeft: 5 }}
          ...
          <ScrollArea className="h-[80vh] px-2">
            <div className="px-2">
              ...
              <Input
                ...
                value={qty || ""}
                onChange={(e) => {
                  if (!isNaN(e.target.value)) setQty(e.target.value);
                }}
              />
              ...
              <Input
                ...
                value={threshold || ""}
                onChange={(e) => {
                  if (!isNaN(e.target.value)) setThreshold(e.target.value);
                }}
              />
        ...
        <tbody style={{ fontSize: 14 }}>
          <tr style={{ height: 40 }}>
            ...
            <td
              ...
              className="border border-gray-300"
            >
              <Label>United Bank Limited (UBL)</Label>
            </td>
          </tr>
          ...
          <tr style={{ height: 40 }}>
            <td className="border border-gray-300">
              <Label style={{ paddingLeft: 5 }}>Account Number</Label>
            </td>
            <td
              style={{ color: "#0072BC", fontWeight: "700", paddingLeft: 5 }}
              className="border border-gray-300 "
          ...
          <tr className="bg-[#FFE4E1]" style={{ height: 40 }}>
            <td className="border border-gray-300">
              <Label style={{ paddingLeft: 5 }}>IBAN</Label>
            </td>
            <td
              style={{ color: "#0072BC", fontWeight: "700", paddingLeft: 5 }}
              className="border border-gray-300 "
          ...
          <tr style={{ height: 40 }}>
            <td className="border border-gray-300">
              <Label style={{ paddingLeft: 5 }}>Branch Code</Label>
            </td>
            <td
              style={{ color: "#0072BC", fontWeight: "700", paddingLeft: 5 }}
              className="border border-gray-300 "
...
const FormField = ({
  ...
  return (
    <div style={{ display: "grid", gap: 0, marginBottom: 5 }}>
      {["Company", "Name", "Contact", "Address", "Manager", "Invoice No"].map(
        (label, index) => (
          <div key={label} style={{ display: "flex", flexDirection: "column" }}>
            <label
              style={{ color: "#7F7F7FFF", marginLeft: 10, fontWeight: "600" }}
            >
              {label}:
            </label>
            <div
