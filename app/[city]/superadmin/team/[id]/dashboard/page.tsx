...
export default async function Page({
    ...
    return (
        <>
            ...
            {designation === "Store Manager" && <StoreManagerDashboard id={id as string} />}
            {designation === "Social Media Manager" && <SMMDashboard id={id as string} />}
            {designation === "Customer Relationship Manager" && (admin === "true" ?
                <CRMDashboard userID={id as string} /> : <CRMDashboardPage id={id as string} />)}
            {designation === "Customer Relationship Manager (After Sales)" && <AfterSalesDashboardNew userID={id as string} />}
