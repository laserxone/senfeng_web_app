  ...
  return loading ? (
    ...
    <Card className="w-full rounded-2xl shadow-md">
      <CardContent>
        ...
        <div
          className={`relative flex min-h-[calc(100dvh-230px)] flex-1 ${isMobile && "w-[calc(100vw-44px)]"}`}
        >
                  ...
                  <TableRow key={idx}>
                    <TableCell className="break-words whitespace-normal">
                      <Link
                        ...
                        href={`/${base_route}/member/${sale.customer_id}`}
                        target="blank"
                      >
                        {sale.name}
                      </Link>
                    ...
                    <TableCell className="break-words whitespace-normal">
                      <Link
                        className="hover:underline"
                        target="blank"
                        href={`/${base_route}/member/${sale.customer_id}/${sale.sale_id}`}
                      >
                        {sale.serial_no}
                      </Link>
                    </TableCell>
