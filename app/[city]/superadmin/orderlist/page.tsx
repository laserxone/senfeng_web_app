          ...
          <div className="flex items-center gap-3">
            ...
            {sortState && (
              <button
                ...
                className="inline-flex items-center gap-1 rounded-full border border-border bg-muted px-2.5 py-0.5 text-xs text-muted-foreground transition-colors hover:bg-muted/80"
              >
        ...
        {movedRow && (
          <div className="flex items-center justify-between gap-4 border-b border-amber-200 bg-amber-50 px-6 py-3 dark:border-amber-900/40 dark:bg-amber-950/20">
            <div className="flex items-center gap-2.5">
              <MoveVertical className="h-4 w-4 shrink-0 text-amber-600 dark:text-amber-400" />
            ...
            <div className="flex shrink-0 items-center gap-2">
              <kbd className="rounded border border-amber-200 bg-amber-100 px-1.5 py-0.5 font-mono text-xs text-amber-700 dark:border-amber-800 dark:bg-amber-900/40 dark:text-amber-400">
                Esc
              </kbd>
              ...
              <button
                onClick={cancelMove}
                className="ml-1 rounded p-1 text-amber-600 transition-colors hover:bg-amber-100 dark:text-amber-400 dark:hover:bg-amber-900/40"
              ...
              return (
                ...
                >
                  ...
                  <td className="relative w-10 px-3 py-0 text-center align-middle">
                    {isBeingMoved && (
                      <span className="absolute top-0 bottom-0 left-0 w-0.5 rounded-r bg-amber-400" />
                    )}
                    <div
                  ...
                  <Td>
                    <span
                      className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${
                        row.has_sale
                          ? "bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200 ring-inset dark:bg-emerald-950/30 dark:text-emerald-400 dark:ring-emerald-800/50"
                          : "bg-orange-50 text-orange-700 ring-1 ring-orange-200 ring-inset dark:bg-orange-950/30 dark:text-orange-400 dark:ring-orange-800/50"
                      }`}
                    >
                  ...
                  <td className="p-0 align-middle">
                    <input
                      ...
                      className="h-full min-h-[44px] w-full min-w-[148px] bg-transparent px-4 py-2.5 text-xs text-foreground transition-colors outline-none focus:bg-primary/5 focus:ring-1 focus:ring-primary/30 focus:ring-inset dark:focus:bg-primary/10"
                    />
                  </td>
        ...
        >
          ...
          <div className="p-1">
            ...
            <button
              ...
              disabled={!movedRow}
              className="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-sm text-foreground transition-colors hover:bg-muted disabled:cursor-not-allowed disabled:opacity-40"
            >
...
function SortableTh({
  ...
  if (sortKey === null) {
    return (
      <th
        className={`px-4 py-3 text-left text-xs font-semibold tracking-wide whitespace-nowrap text-muted-foreground uppercase ${className}`}
      >
        {label}
      </th>
    )
  ...
  return (
    <th className={`px-4 py-3 text-left whitespace-nowrap ${className}`}>
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded text-xs font-semibold tracking-wide uppercase transition-colors hover:text-foreground ${
...
function Td({
  ...
  return (
    <td
      className={`px-4 py-2.5 align-middle text-sm whitespace-nowrap ${className}`}
    >
      {children}
    </td>
  )
  ...
  return (
    <td className="p-0 align-middle">
      <input
        ...
        className="h-full min-h-[44px] w-full min-w-[140px] bg-transparent px-4 py-2.5 text-sm text-foreground transition-colors outline-none placeholder:text-muted-foreground/40 focus:bg-primary/5 focus:ring-1 focus:ring-primary/30 focus:ring-inset dark:focus:bg-primary/10"
        placeholder="—"
      />
    </td>
  )
