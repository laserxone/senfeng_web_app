    ...
    customersWithoutFeedback.push({
      ...
      ...previousInfo
        ...
        const responseData = {
            ...
            satisfied: customersWithFeedback.filter((item) => item.feedback_status === 'Satisfactory').length,
            unsatisfied: customersWithFeedback.filter((item) => item.feedback_status !== 'Satisfactory').length
        }
